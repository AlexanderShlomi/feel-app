<script>
    ...
    // עריכת ה-Transform המקומי לפני שמירה
    let localTransform = { ...transform };

    // עדכון כשה-Props משתנים מבחוץ
    ...
    function handleMove(e) {
        ...
        // עדכון מיקום (ללא גבולות כרגע, הגבולות יחושבו בשמירה או תוך כדי אם נרצה)
    ...
    function onSave() {
        // חישוב המיקומים היחסיים (Percentage) לשמירה רספונסיבית
...
<style>
    ...
    .split-editor-viewport {
        ...
        /* ברירת מחדל, המידות יידרסו ע"י הורה במידת הצורך או יחושבו ב-JS אם נרצה להעביר לפה */
